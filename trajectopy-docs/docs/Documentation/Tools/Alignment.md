...
**Args:**
 ...
 - <b>`trajectory`</b> (Trajectory):  Trajectory to apply alignment to alignment_result (AlignmentResult) 
...
**Args:**
 ...
 - <b>`traj_from`</b> (Trajectory):  Trajectory where f 
 - <b>`inplace`</b> (bool, optional):  Perform in-place. Defaults to True. 
...
**Args:**
 ...
 - <b>`trajectory`</b> (Trajectory):  Trajectory that will be changed 
 - <b>`other`</b> (Trajectory):  Trajectory to adopt the first position from 
 - <b>`inplace`</b> (bool, optional):  Perform in-place. Defaults to True. 
