...
class DOFOrganizer(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.x_bias.setMinimum(-1000000.0)
        self.x_bias.setMaximum(1000000.0)
        ...
        self.y_bias.setMinimum(-1000000.0)
        self.y_bias.setMaximum(1000000.0)
        ...
        self.z_bias.setMinimum(-1000000.0)
        self.z_bias.setMaximum(1000000.0)
